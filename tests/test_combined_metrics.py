...
class LabeledEvaluationTests(unittest.TestCase):
    def test_full_and_marker_free_metrics_use_same_samples(self):
        records = [
            ...
            {"label": "uploaded", "combined_risk_score": 99, "marker_free_risk_score": 99, "combined_risk_reasons": ""},
        ]
    ...
    def test_seal_review_signals_remain_neutral(self):
        reasons = [
